...
/// <summary>
/// Bir agent'a eklenmiş typed tool kaydını temsil eder.
/// </summary>
/// <param name="ToolType">Tool sınıfının CLR tipidir.</param>
/// <param name="InputType">Tool input modelinin CLR tipidir.</param>
/// <param name="OutputType">Tool output modelinin CLR tipidir.</param>
/// <param name="Name">Model tarafında kullanılacak tool adıdır.</param>
/// <param name="Description">Model tarafına gönderilecek tool açıklamasıdır.</param>
...
{
    /// <summary>
    /// Verilen tool tipinden agent tool kaydı üretir.
    /// </summary>
    /// <param name="toolType">IRuniqTool&lt;TInput,TOutput&gt; uygulayan somut tool tipidir.</param>
    /// <returns>Agent'a eklenebilecek tool kayıt bilgisini döner.</returns>
