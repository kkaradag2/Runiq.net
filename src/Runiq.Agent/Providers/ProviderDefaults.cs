namespace Runiq.Agents.Providers
{
    /// <summary>
    /// Model sağlayıcılarının Runiq tarafından bilinen varsayılan bağlantı ve protokol bilgilerini tutar.
    /// </summary>
    internal static class ProviderDefaults
    {
        ...
        /// <summary>
        /// Provider adının Runiq tarafından desteklenip desteklenmediğini doğrular.
        /// </summary>
        ...
        /// <summary>
        /// Provider adına karşılık gelen varsayılan sağlayıcı bilgisini döndürür.
        /// </summary>
        ...
        /// <summary>
        /// Provider için kullanılacak endpoint adresini çözer.
        /// Agent üzerinde özel URL verilmişse onu, aksi halde provider varsayılan URL değerini kullanır.
        /// </summary>
    ...
    /// <summary>
    /// Runiq'in sağlayıcıyla hangi HTTP protokolü üzerinden konuşacağını belirtir.
    /// </summary>
    ...
    /// <summary>
    /// Bir model sağlayıcısının varsayılan protokol ve bağlantı bilgilerini temsil eder.
    /// </summary>
